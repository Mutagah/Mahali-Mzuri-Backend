...
puts "Seeding Database tables"
    ...
    puts "Seeding room type data...."

        room1= RoomType.create(room_type:"Executive Size",description:"Ideally best suited for 5 guests, master ensuite for a couple, one twin bedroom and a single room.",
        bedroom_capacity:5,
        number_of_rooms:10,
        price:145,
